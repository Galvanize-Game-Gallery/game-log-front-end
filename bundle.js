...
//populate navbar
    ...
    for (let platform of userPlatforms) {
      if (userPlatforms.indexOf(platform) === 0) {
        navBar.innerHTML +=`<a class="nav-item nav-link btn active" id="${platform.name}-tab" data-toggle="tab" role="btn"
